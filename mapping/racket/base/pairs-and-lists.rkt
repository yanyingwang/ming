...
>>> list? 􏿴?
>>> build-list 垿 "构造序􏿴（􏿴内的各个个元素是按照一定次序排列的􏿴即为序􏿴）" ;; 垿 序
...
>>> append 􏾟 @elem{把多􏿴贯穿相连组成一个@racket[􏿴]并返回之} ;; 串 接 通 捅 􏿝
...
>>> andmap 􏷮 @elem{各个元素全都是...} ;; 各有应 各都 映且 且佫 全 各且 􏷱
>>> ormap 􏷭 @elem{各个元素有的是...} ;; 各无应 各有 映或 或佫 有 各或 􏷰
