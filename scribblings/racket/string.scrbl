...
@item{“坚诗”与之相反，是一种内容固定不能被修改的字符串数据结构，通过半格双引号@racket[""]创建出来的诗是“坚诗”。要注意的是，所谓的“不能被修改”从代码的角度讲，很多时候会不容易被注意到，这是因为很多诗相关的例程在处理“坚诗”的时候，会新生成“易诗”并作为结果替换输出之，间接的完成了“坚诗”到“易诗”的转化。真正操作“诗”的原始数据并加以修改的例程都会以@racket[!]结尾以表警示。}
]
