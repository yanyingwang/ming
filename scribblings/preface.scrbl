...
另外，对于函数式编程语言，其世界仿佛是平的，所有被命名的数据亦或待使用的函数好像都是生活在同一个空间里的，因此这些名字越是有逻辑，越是能体现出它和周围其他名字的关联关系，对使用者而言就越有意义。
...
@smaller{另可续读：《@secref["the future of chinese programming language and chinese characters"]》。}
